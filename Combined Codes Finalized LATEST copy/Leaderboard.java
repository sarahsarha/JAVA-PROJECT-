...
public class Leaderboard implements Savable {
    ...
    public void addScore(String playerName, int score) {
        ...
        String updatedRecord = cleanedName + "," + currentTotalScore + "," + badge;
    ...
    public String getTopPlayersData() {
        ...
        builder.append("====================================================================\n");
        builder.append(String.format("%-6s %-18s %-8s %-22s\n", "Rank", "Player Name", "Score", "Eco-Badge Title"));
        builder.append("--------------------------------------------------------------------\n");
        ...
        for (String record : sortedList) {
            ...
            String badge = (data.length > 2) ? data[2] : "LEGACY";
            
            builder.append(String.format("#%-5d %-18s %-8s %-22s\n", rank, data[0], data[1], badge));
            rank++;
            if (rank > 10) break;
        }
        builder.append("====================================================================");
